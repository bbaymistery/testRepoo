...
const Hero = (props) => {
  let { isBgImageActive, isHeroContentActive, env } = props
        ...
        <div className={styles.containerr}>
          <div className={styles.content}>
            ...
            <div className={styles.tab_content}>
              <h1 className={styles.tab_pane_title}>
              ...
              <div className={styles.tab_pane}>
                {jouryName === "Return" && (
                  <h2 className={styles.trdetails_title}>Transfer Details</h2>
                )}
                <Oneway
                  jouryName={jouryName}
                ...
                {jouryName === "Return" ? (
                  <h2 className={styles.returndetails_title}>Return Details</h2>
                ) : <></>}
                {jouryName === "Return" ? (
                  <ReturnDynamic
                    jouryName={jouryName}
