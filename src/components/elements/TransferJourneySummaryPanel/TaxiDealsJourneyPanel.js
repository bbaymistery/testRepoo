...
const TaxiDealsJourneyPanel = (props) => {
    let {
        ...
        distanceInMiles, distanceInKm, formattedDuration, quotations, index, carObject,
    } = props
    return (
        <>
            ...
            <div className={`${styles.content} ${styles.summarycontent}`} style={{ marginTop: "2rem" }}>
                ...
                <div className={styles.price_div}>
                    ...
                    <div className={styles.price}>£ {quotation.normalPrice ? quotation.normalPrice : quotation.price}</div>
                </div>
            </div>
        </>
    )
