...
const HandleSearchResults = (params = {}) => {
    let { collectingPoints, destination, setInternalState, index, getQuotations = () => { }, language, isTaxiDeal = false, isTours = false, env ,fetchArchieveToken=()=>{}} = params
    ...
    const handleAddItemToSelectList = (params = {}) => {
        ...
        //make one request more if point pcatId is equal to 10 ptypeto3 google points
        if (point.ptype === 3) {
            (async () => {
