          ...
          <div className={styles.left_items}>
            <div className={styles.left_items_flex_div}>
              ...
              <div ref={mobileMenu} className={`${styles.header_content_menu_mobile} `}>
                {openMenu ? <MobileMenu handleClickNavLinkMobileMenuNotList={handleClickNavLinkMobileMenuNotList} language={language} handleClickNavLinkMobileMenuList={handleClickNavLinkMobileMenuList} /> : <></>}
              </div>
            </div>
          </div>
