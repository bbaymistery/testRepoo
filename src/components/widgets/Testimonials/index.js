        ...
        <div className={`${styles.testimonials} ${direction} page`} bggray={String(bggray)}>
            <div className={`${styles.testimonials_section} page_section`}>
                <div className={`${styles.testimonials_section_container} page_section_container`}>
                    ...
                    <br />
                    <h2>What is Included in the Airport Taxi Service?</h2>
                    <p>Our comprehensive airport private car fares come with the following as standard:</p>
                    <br />
                    <ul>
                        <li>Airport meet and greet</li>
                        <li>No charges for flight delays – we wait for free</li>
                        <li>Flight tracking</li>
                        <li>Age-appropriate baby/child seats (upon request)</li>
                    </ul>
                    <br />
                    ...
                    <br />
                    <h2>Executive/Business Class Airport Chauffeur Transfers</h2>
                    <p>For those seeking an elevated travel experience or business trips, APL Cars' 'Business Class' transfer service offers:</p>
                    <br />
                    <ul>
                        <li>Luxury vehicles</li>
                        <li>Complimentary laptop usage</li>
