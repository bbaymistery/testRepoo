    ...
    const getQuotations = useCallback((e) => {
        ...
        if (errorHolder.status === 200) {
            let propsOfReadyColection = {
                ...
                message: "APL Hero - getQuotations() inside hero component message",

            }
            readyToCollectQuotationOptions(propsOfReadyColection)
            console.log('readyToCollectQuotationOptions propsOfReadyColection', propsOfReadyColection);
                                    ...
                                    <div key={index}>
                                        ...
                                        <div className={`${styles.points} ${direction}`} direction={String(direction === "rtl")}>
                                            ...
                                            {reservations.length > 1 && index === 0 ?
                                                <div className={`${styles.btn_div} ${styles.hide_mobile} `}  >
                                                    {internalState[`quotation-loading`] ?
