      ...
      {items.map((item) => {
        return (
          <li
            ...
            key={item.id}
          >
            <a className={styles.book_item} href={item.href}>
              <div className={styles.row}>
                ...
                <div className={`${styles.second_col} ${styles.col}`}>
                  ...
                  <h2 className={styles.booking_item_title}>{item.title}</h2>
                  {item.address && <p className={styles.booking_item_adress}>
                  ...
                  {item.description && <p className={styles.booking_item_description}>
                    {item.description}
                  </p>}
                </div>
