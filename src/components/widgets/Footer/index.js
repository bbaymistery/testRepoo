        ...
        <div className={`${styles.footer_section_container} page_section_container`}>
          <div className={styles.content}>
            ...
            <div className={styles.column}>
              <h3>Support</h3>
              <ul className={styles.list_items}>
                <Link href={`${language === 'en' ? `/contact-us` : `${language}/contact-us`}`} title={appData.words["appContactUsHeader"]} tabIndex="-1" >
          ...
          <div className={styles.subcontent}>
            ...
            <div className={styles.subcontent_left}>
              ...
              <ul className={styles.lists}>
                <Link href={`${language === 'en' ? `/terms` : `${language}/terms`}`} title={appData.words["strPrivacyPolicy"]} tabIndex="-1" >
                  {appData.words["strPrivacyPolicy"]}
                </Link>
                <Link href={`${language === 'en' ? `/terms` : `${language}/terms`}`} title={appData.words["strTermsOfUse"]} tabIndex="-1" >
