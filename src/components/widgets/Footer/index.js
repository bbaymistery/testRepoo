          ...
          <div className={styles.content}>
            ...
            <div className={styles.column}>
              ...
              <ul className={styles.list_items}>
                ...
                <li>
                  <a href={`${language === 'en' ? `/special-assistance-transfers` : `/${language}/special-assistance-transfers`}`}  >
                    {(appData || {})?.words["strSpecialAssistanceTransfers"] || "Special Assistance Transfers"}
                  </a>
                </li>


                <li>
                  <a href="https://ai.airport-pickups-london.com/" target="_blank" rel="noopener noreferrer">
                    APL AI
                  </a>
                </li>
                <li>
                  <a href="https://mcp.airport-pickups-london.com/docs" target="_blank" rel="noopener noreferrer">
                    API Docs
                  </a>
                </li>
              </ul>
