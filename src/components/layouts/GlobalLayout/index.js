...
const GlobalLayout = ({ innerHeadTags, children, mainCanonicalUrl, title = seoDefaults.title, description = seoDefaults.description, footerbggray = seoDefaults.footerbggray, llmsHref }) => {
  ...
  return (
    <>
      <Head>
        ...
        {router.pathname === "/" && <link rel="llms" href={llmsHref} />}
        ...
        {Array.isArray(innerHeadTags) && innerHeadTags.length > 0 &&
