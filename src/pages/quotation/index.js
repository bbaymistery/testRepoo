            ...
            {!showOnlyTransferCOmp && (
              <div className={styles.quotation_container}>
                <div className={styles.quotation_panel}>
                  ...
                  <OneWayForQuotatiaon  env={env} btnTittle={"Update "} border={"blue"} responsive={true} showHeader={true} fromQuotation={true} />
                  {selectedPickUpsOneWay?.length > 0 &&
                    selectedDropOffOneWay?.length > 0 &&
                    selectedTrQuots.status === 200 ?
                    <Map
            ...
            {!showOnlyTransferCOmp && (
              <div className={styles.quotation_container}>
                <div className={styles.quotation_panel}>
                  ...
                  <ReturnForQuoation env={env} btnTittle={"Update "} border={"blue"} responsive={true} remainReturnSide={true} fromQuotation={true} />
                  {selectReturnPickUp?.length > 0 && selectReturnDropOf?.length > 0 && selectedReturnQuots.status === 200 ?
                    <Map env={env} datas={selectedReturnQuots} selectedPickPoints={selectedPickUpsOneWay} selectedDroppOfPoints={selectedDropOffOneWay} /> : <></>
                  }
