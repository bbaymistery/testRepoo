...
const Informations = ({
  ...
  return (
    <div
      className={`${styles.details_header} ${hidePassengers && styles.booking_header
        }`}
    >
      {carObject && (
        <div>
            ...
            <div className={styles.card_top}>
              {!hidePassengers && (
                <div className={styles.card_info}>
                  <p className={styles.right_title}>Passenger Details</p>
              ...
              <div className={styles.card_right}>
                <p className={styles.right_title}>Transfer Details</p>
                <div className={styles.info}>
                  <ul>
                    <li>
                        ...
                        <div className={styles.details_bottom_container}>
                          <div className={styles.details_bottom}>
                            ...
                            <span className={styles.desc}>
                              {formatDate(date, "short") ? formatDate(date, "short"): date.split(" ")[0]}
                            </span>
