...
const ReservDocuments = (props) => {
  ...
  const fetchArchieveToken = async (params = {}) => {
    ...
    let reservationObj = slectPickUpPointsReturn?.length >= 1 && selectedPickUpPointsTr.length >= 1 ? reservations : [reservations[0]]
  ...
  const submitDataToGetReservId = () => {
    ...
    let body = JSON.stringify({
      reservation: slectPickUpPointsReturn?.length >= 1 && selectedPickUpPointsTr.length >= 1 ? reservations : [reservations[0]],
    ...
    var requestOptions = { method: "POST", headers: { "Content-Type": "application/json" }, body };
              ...
              <div className={styles.reserv_container}>
                ...
                <div className={styles.invoice} id="pdf_file">
                    ...
                    <div className={styles.invoice_left_center}>
                      ...
                      >
                        ...
                        <p>
                          ...
                          <span style={{ paddingRight: "5px" }}><i className="fa-brands fa-whatsapp"></i> </span>
                          +447387901028<br />
                  ...
                  <div className={styles.invoice_right}>
                    ...
                    {formatDate(trDateTime, "short") ? formatDate(trDateTime, "short") : trDateTime
                              .split(" ")[0]
                              .replace(/(\d+)\-(\d+)-(\d+)/, "$3-$2-$1")}
