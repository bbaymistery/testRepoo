...
const PickUpPoints = ({ selectedPickupPoints, direction, pickUpDate, pickUpTime, language }) => {
  ...
  return (
    <div className={styles.stop}>
      {selectedPickupPoints?.map((point, i) => {
        ...
        return (
          <div key={i}>
            <div className={`${styles.stopDot} ${styles.stopDotPickup}`}></div>
              ...
              <div className={direction}>
                ...
                <div className={styles.badges}>
                  <span className={styles.badge}>
                    <i className="fa-regular fa-calendar"></i> {formatDate(pickUpDate, "short", language)}
                  </span>
                  <span className={styles.badge}>
                    <i className="fa-regular fa-clock"></i> {pickUpTime}
                  </span>
                </div>
              </div>
