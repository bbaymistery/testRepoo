...
const FAQ = (props) => {
    ...
    return (
        <GlobalLayout innerHeadTags={extractedHeadTags} mainCanonicalUrl={mainCanonicalUrl} keywords={keywords} title={metaTitle} description={metaDescription} footerbggray={true}  >
            <div className={`${styles.faq} ${direction} page`} bggray={String(bggray === "true")}  >
                <div className={`${styles.faq_section} page_section`}>
                    <div className={`${styles.faq_section_container} page_section_container`} >
...
export async function getServerSideProps({ req }) {
    ...
    const { metaTitle, keywords, pageContent, metaDescription, shortDescription, pageTitle, canonicalUrl: mainCanonicalUrl, } =
        await fetchContent("/faq", cookie, firstLoadLangauge, pathname, "/faq");
