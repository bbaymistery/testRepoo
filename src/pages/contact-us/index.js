                            ...
                            <div className={styles.contact_container}>
                                <div className={styles.left}>
                                    ...
                                    {waitingTimeCharges.map((ac, i) => {
                                        return (
                                            <Accordion key={i} dangerouslyHtml={true} title={ac.title} active={active} setActive={setActive} toggleState={toggleState} content={ac.content} />
                                        );
                                    })}
                                    <p className={styles.popular_topics_title}>Vehicles and Services</p>
                                    {vehicles.map((ac, i) => {
                                        return (
                                            <Accordion key={i} dangerouslyHtml={false} title={ac.title} active={active} setActive={setActive} toggleState={toggleState} content={ac.content} />
                                        );
                                    })}
