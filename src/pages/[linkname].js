...
async function handleQuotationLink(language, pathname, schemas, env, ipAddress, userAgent) {
    ...
    if (pathname) {
        const body = {
            language, checkRedirect: true,
            taxiDealPathname: pathname,
            withoutExprectedPoints: true, visitorIpAddress: ipAddress, "userAgent": userAgent, bodyOfRequest: "", methodOfRequest: "",
            "channelId": 2
        }
