...
const NeedHelp = ({ appData }) => {
    ...
    const whatsapNumber=appData?.config?.configAPLWhatsappNumber||"+447538989360"
        /**
    ...
    return (
        <div className={styles.footerHelp}>
            ...
            <div className={styles.contactLinks}>
                ...
                {/* Telefon */}
                <a href={`tel:+${whatsapNumber}`} target="_blank" rel="noreferrer" className={styles.linkGreen}>
