...
const PassengerWhatsapCheckBox = ({ text, direction }) => {
    ...
    return (
        <div className={styles.form_checkbox} direction={String(direction === 'rtl')}>
            <input className={styles.checkbox} type="checkbox" id="psg-checkbox" checked={pasStatus} />
...
export default PassengerWhatsapCheckBox;
