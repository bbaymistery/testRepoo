...
import PassengerWhatsapCheckBox from './PassengerWhatsapCheckBox';
const HandlePassengerDetailsTransferForm = (props) => {
    let { passengerDetailsStatus, index, appData, reservationError, firstname, email, passengersNumber, phone, quotation, direction ,taxiDeal=false} = props
            ...
            <div className={styles.passenger_details}>
                ...
                <div className={styles.input_div}>
                    ...
                    />
                                            ...
                                            {taxiDeal && <PassengerWhatsapCheckBox direction={direction} text={appData?.words["textWhatsappNotificationSubscriptionDescriptionAtWebsite"]} />}
