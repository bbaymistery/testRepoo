 ...
 */
const SpecialAsistanceTransfers = (props) => {
    ...
    return (
        <GlobalLayout innerHeadTags={extractedHeadTags} mainCanonicalUrl={mainCanonicalUrl} keywords={keywords} title={metaTitle} description={metaDescription} footerbggray={true}  >
            <div className={`${styles.speacial_asistance} ${direction} page`} bggray={String(bggray === "true")}  >
                <div className={`${styles.speacial_asistance_section} page_section`}>
                    <div className={`${styles.speacial_asistance_section_container} page_section_container`} >
...
export default SpecialAsistanceTransfers;
...
export async function getServerSideProps({ req }) {
    ...
    const { metaTitle, keywords, pageContent, metaDescription, shortDescription, pageTitle, canonicalUrl: mainCanonicalUrl, } =
        await fetchContent("/special-assistance-transfers", cookie, firstLoadLangauge, pathname, "/special-assistance-transfers");
