...
const Payment = (props) => {
  ...
  useEffect(() => {
    ...
    dispatch({ type: "CHECK_JOURNEY_TYPE", payload: selectedDropPointsTr.length >= 1 && slectPickUpPointsReturn.length >= 1 ? 1 : 0 });
      ...
      <div className={styles.payment_section}>
        <div className={styles.section}>
          <div className={styles.payment_container}>
            ...
            <PaymentDetails setConfirmation={setConfirmation} env={env} />
          </div>
        </div>
      </div>
    </Layout>
