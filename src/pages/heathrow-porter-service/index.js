...
export async function getServerSideProps({ req, res }) {
    ...
    let pathNameUrlCanonical = "/heathrow-porter-service"
    let { metaTitle, keywords, pageContent, metaDescription, shortDescription, pageTitle,canonicalUrl: mainCanonicalUrl } =
     await fetchContent("/heathrow-porter-service", cookie, firstLoadLangauge, pathnameUrlWHenChangeByTopbar,pathNameUrlCanonical)
    return {
