...
export default function HomePage(props) {
  let { status, file, hasSearchEngine, data, head, filename, articlePath, env } =
    props;
        ...
        <React.Fragment>
          ...
          {hasSearchEngine ? (
            <div style={{ maxWidth: "1200px", margin: "0 auto", }}  >
              <OneWay fromArticle={true} preSelectedPickupPoint={data.preSelectedPickupPoints} preSelectedDropoffPoint={data.preSelectedDropoffPoints} env={env} />
            </div>
          ) : (
